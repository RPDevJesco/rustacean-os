...
//!
//! Handles PS/2 keyboard input and dispatches events through the kernel EventChain.
...
impl KeyCode {
    ...
    /// Get ASCII character for this key (if applicable)
...
impl Keyboard {
    ...
    /// Process a scancode and return the key event
    ...
    /// Get ASCII character for a key event
